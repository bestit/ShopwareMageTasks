...
class ApplyMigrationsTask extends AbstractTask
{
     ...
     * @var string
     */
    private const DEFAULT_MIGRATION_DIR = 'sql';
     ...
     * @var string
     */
    private const DEFAULT_SCRIPT_DIR = 'scripts';
     ...
     * @var string
     */
    private const DEFAULT_SHOP_PATH = '.';
     ...
     * @var string
     */
    private const DEFAULT_TABLE_SUFFIX = 'bestit';
